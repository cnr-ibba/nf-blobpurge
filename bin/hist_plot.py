...
#
# Vendored from https://github.com/dfguan/purge_dups/blob/master/scripts/hist_plot.py
# (MIT licensed) -- not distributed by the bioconda/biocontainers purge_dups
# package, which only ships the compiled C binaries.
